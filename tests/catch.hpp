...
namespace Catch {
    ...
    struct FatalConditionHandler {
        ...
        static char altStackMem[32768]; //static char altStackMem[SIGSTKSZ]; 
        ...
        FatalConditionHandler() {
            ...
            sigStack.ss_size = 32768; //sigStack.ss_size = SIGSTKSZ;
            sigStack.ss_flags = 0;
    ...
    char FatalConditionHandler::altStackMem[32768] = {}; //char FatalConditionHandler::altStackMem[SIGSTKSZ] = {};
